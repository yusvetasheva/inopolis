...
@Tag(name = "Seller Controller", description = "Контроллер для работы с продавцами")
public class SellerController {
    SellerService service;

    @PostMapping(value = "/create")
    @Operation(summary = "Добавить продавца", description = "Доступно для роли ADMIN",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Данные продавца добавлены"),
    ...
    @Operation(summary = "Удалить продавца по id", description = "Доступен для роли ADMIN",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Продавец удален"),
                    @ApiResponse(responseCode = "403", description = "Недостаточно прав"),
                    @ApiResponse(responseCode = "404", description = "Нет продавца с таким идентификатором")
            })
    ...
    @Operation(summary = "Обновить продавца по id", description = "Доступен для ролей ADMIN, USER",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Продавец обновлен"),
                    @ApiResponse(responseCode = "403", description = "Недостаточно прав"),
                    @ApiResponse(responseCode = "404", description = "Нет продавца с таким идентификатором")
            })
