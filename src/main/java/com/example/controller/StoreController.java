...
@Tag(name = "StoreController", description = "Контроллер для работы со складами")
public class StoreController {
    StoreService service;

    @PostMapping(value = "/create")
    @Operation(summary = "Создать склад", description = "Доступ: только ADMIN",
            responses = {
                    @ApiResponse(responseCode = "201", description = "Склад создан"),
